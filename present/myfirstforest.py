...
csv_file_object = csv.reader(open(training_file_name, 'rb')) #Load in the training csv file
...
test_file_object = csv.reader(open(testing_file_name, 'rb')) #Load in the test csv file
...
open_file_object = csv.writer(sys.stdout)
